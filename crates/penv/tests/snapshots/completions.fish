...
complete -c penv -n '__fish_penv_at ""' -a 'init' -d 'Create .env.schema from your .env and keep .env out of git'
complete -c penv -n '__fish_penv_at ""' -a 'run' -d 'Run a command with your secrets loaded into it'
complete -c penv -n '__fish_penv_at ""' -a 'push' -d 'Send your local .env to the cloud, then delete the file'
complete -c penv -n '__fish_penv_at ""' -a 'pull' -d 'Write a .env file from the cloud'
complete -c penv -n '__fish_penv_at ""' -a 'login' -d 'Sign in'
...
complete -c penv -n '__fish_penv_at ""' -a 'bundle' -d 'Write an encrypted file of one environment'\''s values for a deploy'
complete -c penv -n '__fish_penv_at ""' -a 'encrypt' -d 'Encrypt the secrets in your .env files'
complete -c penv -n '__fish_penv_at ""' -a 'decrypt' -d 'Write the .env files'\'' secrets back in plain text'
complete -c penv -n '__fish_penv_at ""' -a 'why' -d 'Say where a key'\''s value comes from, never the value'
complete -c penv -n '__fish_penv_at ""' -a 'check' -d 'Find problems in .env.schema and missing values'
...
complete -c penv -n '__fish_penv_at ""' -a 'guard' -d 'Write the rules that keep AI tools out of .env'
